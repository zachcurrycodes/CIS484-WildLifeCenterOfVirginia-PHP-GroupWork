...
if(isset($_POST['btnUpdate'])){
	...
	{
		$query = "UPDATE LogHours SET LogHours_DayHours = ROUND((TIMESTAMPDIFF(HOUR, LogHours_BeginTime, LogHours_EndTime)/60),2), LastModifiedBy = ".$userID.", LastModifiedDate = NOW()
		WHERE LogHours_ID =" .$idEntered;
